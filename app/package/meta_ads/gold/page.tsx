...
const PricingPage: React.FC = () => {
  return (
    <div className="bg-black text-white p-4 sm:p-8 min-h-screen max-w-screen-xl mx-auto w-full cp">
      ...
      {/* Body */}
      <div>
        {metaAds.metaAdsGoldPackage.map((section: any, sectionIndex: any) => (
          <div key={sectionIndex}>
            ...
            {Object.keys(section).map((sectionKey, index) => {
              ...
              return (
                ...
                >
                  {/* Section Header */}
                  <div className="gap-4 py-4 common-para-all meta-ads-common-sticky-header z-40 bg-black">
