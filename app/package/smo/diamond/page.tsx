    ...
    <div className="bg-black text-white p-4 sm:p-8 min-h-screen max-w-screen-xl mx-auto w-full cp">
      ...
      <header className="sticky smo-common-height smo-common-margin top-0 z-50 bg-black">
        ...
        <div className="grid grid-cols-2 gap-4 py-3">
          ...
          <div className="text-center">₹40,000 / Month</div>
        </div>
      </header>

      {/* Body */}
      <div>
        {smo.smoDiamondPackage.map((section: any, sectionIndex: any) => (
              ...
              return (
                ...
                >
                  ...
                  <div className=" gap-4 py-4 smo-common-sitcky-header bg-black">
                    <div className="text-left  font-semibold text-[1.25rem] md:text-2xl">
